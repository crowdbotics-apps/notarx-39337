"""
Django settings for notarx_39337 project.
...
ROOT_URLCONF = 'notarx_39337.urls'
...
WSGI_APPLICATION = 'notarx_39337.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "notarx_39337 API",
    "DESCRIPTION": "API documentation for notarx_39337 App",
    "VERSION": "v1",
}
